...
- Description: 12 V positive linear voltage regulator
...
- Official specification page: https://estore.st.com/en/l7812cv-cpn.html
- Revision: Live ST eStore product page snapshot, accessed 2026-08-07
- Accessed: 2026-08-07
- Referenced sections: Parameters, Description, Key features
- HTML SHA-256: `b533bd23cb3c2263ec58300bd1c46b5d743ebe3e4a413ad11f211057bdc45b6b`
...
| --- | ---: | --- |
| VREF | 12 | datasheet_typical_or_derived |
...
| --- | ---: | ---: | --- | ---: | --- |
| nominal/reference endpoint | 12 | 11.999674 | V | 0.003% | Official ST eStore active product heading and Key features |
| output at 1.5 A boundary | 12 | 11.945069 | V | 0.458% | Official ST eStore Key features output-current capability |

Worst fitting error: 0.458% for output at 1.5 A boundary.

Native and WASM agreement: all 3 benches passed. Worst relative engine delta was 8.786e-15; worst absolute delta was 4.619e-14.
