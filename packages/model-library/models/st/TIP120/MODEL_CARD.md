...
- Electrical family: NPN Darlington power transistor
- Fidelity tier: F1 composite terminal behavior, F1 internal nodes
- Independent reviewer: pending-review

## Provenance

- Specification page: https://www.st.com/en/power-transistors/tip120.html
...
The shipped subcircuit contains two Gummel-Poon transistors, R1=7000 ohm, R2=70 ohm, and the internal freewheel diode in the datasheet topology. The driver transistor is scaled to one tenth the output current capability. Only composite C-B-E behavior is constrained.

## Validation

Factory validation passed: 4 benches, 7 of 7 checks, native/WASM agreement green. Worst engine relative delta: 1.754e-11. No typical fit error is claimed because accessible electrical rows are guaranteed bounds.
