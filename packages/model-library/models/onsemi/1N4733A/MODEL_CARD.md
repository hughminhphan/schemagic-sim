...
- Manufacturer: onsemi
- Description: 5.1 V silicon zener diode
...
- Source: https://www.onsemi.com/products/discrete-power-modules/zener-diodes/1N4733A
- Kind: spec_page
...
- SHA-256: `a659d654e3cd5d009ce908e81e3f522f3ba9ef38d84be2f77a8c68ddb8df1602`
...
| IBV | 0.049 | paired with BV at IZT |
...
| --- | ---: | ---: | --- | ---: | --- |
| zener voltage at 0.001 A | 4.9993888 | 5.0000092 | V | 0.0124% | official product page, zener voltage table, zener voltage and differential resistance rows |
| zener voltage at 0.049 A | 5.1 | 5.1000049 | V | 0.0001% | official product page, zener voltage table, zener voltage row at IZT |

Worst reported fitting error: 0.0124% (zener voltage at 0.001 A).

## Validation

- Native ngspice-46 and WASM agreement: 3/3 benches.
- Expectation checks: 3/3 passed.
- Worst native/WASM relative delta: 2.019e-19.
- Worst native/WASM absolute delta: 2.019e-28.
