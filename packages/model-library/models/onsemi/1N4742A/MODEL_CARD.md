...
- Manufacturer: onsemi
- Description: 12 V silicon zener diode
...
- Source: https://www.onsemi.com/products/discrete-power-modules/zener-diodes/1N4742A
- Kind: spec_page
...
- SHA-256: `1596b9eb2fd0aed0b605e40e8cc25efa7ca68a2e3aa97c459c163585fae15f96`
...
| BV | 12 | paired with IBV at IZT |
| IBV | 0.021 | paired with BV at IZT |
...
| --- | ---: | ---: | --- | ---: | --- |
| zener voltage at 0.001 A | 11.921293 | 11.921778 | V | 0.0041% | official product page, zener voltage table, zener voltage and differential resistance rows |
| zener voltage at 0.021 A | 12 | 12.000002 | V | 0.0000% | official product page, zener voltage table, zener voltage row at IZT |

Worst reported fitting error: 0.0041% (zener voltage at 0.001 A).

## Validation

- Native ngspice-46 and WASM agreement: 3/3 benches.
- Expectation checks: 3/3 passed.
- Worst native/WASM relative delta: 1.490e-16.
- Worst native/WASM absolute delta: 1.776e-15.
