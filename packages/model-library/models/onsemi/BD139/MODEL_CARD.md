...
- P5 independent review passed F1: guaranteed gain and saturation bounds, an independent in-region gain probe, and all four native and WASM benches passed; the missing independent typical curve family honestly prevents F2.
