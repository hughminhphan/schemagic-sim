...
- Datasheet: https://jlcpcb.com/api/file/downloadByFileSystemAccessId/8564879669842907136
- Revision: Rev1.0
- Accessed: 2026-08-10
...
- F2 evidence did not qualify; staged as F1: Validation failed for 1SMA4729A. See validation-results.json; failed package checks: reverse_leakage_maximum observed 0.000013319319643091378 (maximum 0.00001)
- No capacitance or reverse-recovery data were published. The generic reverse zener-impedance plot contains curves only for VZ = 25 V, 30 V, 65 V, and 91 V, not the 3.6 V 1SMA4729A trace.
