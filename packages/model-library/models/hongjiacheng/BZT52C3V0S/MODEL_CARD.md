...
- Datasheet: https://jlcpcb.com/api/file/downloadByFileSystemAccessId/8564879652520296448
- Revision: Rev:1.0
- Accessed: 2026-08-10
...
- F2 evidence did not qualify; staged as F1: No target-specific usable curve was extracted: the datasheet plots are shared series-level characteristics, and the BZT52C3V0S trace is not individually identified with unambiguous numeric points. Capacitance is shown only in a shared typical series plot without a target-specific tabulated value, and reverse recovery time is not published.
- No target-specific usable curve was extracted: the datasheet plots are shared series-level characteristics, and the BZT52C3V0S trace is not individually identified with unambiguous numeric points. Capacitance is shown only in a shared typical series plot without a target-specific tabulated value, and reverse recovery time is not published.
