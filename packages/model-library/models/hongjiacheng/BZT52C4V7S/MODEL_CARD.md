...
- Datasheet: https://jlcpcb.com/api/file/downloadByFileSystemAccessId/8564879655061504000
- Revision: Rev:1.0
- Accessed: 2026-08-10
...
- usable_curves is false because the datasheet's characteristic figures are generic family raster plots (Fig. 1 has no 4.7 V-labeled trace) and cannot be honestly digitized for this specific part; extraction relies on the part-specific electrical table rows and maximum ratings.
