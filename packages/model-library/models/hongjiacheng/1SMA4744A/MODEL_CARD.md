...
- Datasheet: https://jlcpcb.com/api/file/downloadByFileSystemAccessId/8564879675240841216
- Revision: Rev1.0
- Accessed: 2026-08-10
...
| IBV | 1.70000000e-2 | fitted or derived |
...
- F2 evidence did not qualify; staged as F1: diode F2 gate failed: forward_voltage worst relative error 0.0518 exceeds gate 0.05
- No target-specific zener-impedance curve is published for the 15 V nominal part; Figure 2 only plots VZ = 25 V, 30 V, 65 V, and 91 V. Capacitance and reverse-recovery data are also absent.
