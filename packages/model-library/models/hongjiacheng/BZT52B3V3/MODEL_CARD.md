...
- Datasheet: https://jlcpcb.com/api/file/downloadByFileSystemAccessId/8564879627891478529
- Revision: Rev:1.0
- Accessed: 2026-08-09
- Referenced pages: p. 1, p. 2, p. 3, p. 4
- SHA-256: `12a6f531411e866a8dd2acbad16a6aa069fbc15a48012ac0fe57aa5a00428170`
...
- F2 evidence did not qualify; staged as F1: No usable target-specific curve: the only zener-characteristic trace begins at 5.1 V and the other family curves begin at 4 V, so the 3.3 V BZT52B3V3 trace is not present in the supplied PDF.
- No usable target-specific curve: the only zener-characteristic trace begins at 5.1 V and the other family curves begin at 4 V, so the 3.3 V BZT52B3V3 trace is not present in the supplied PDF.
