# BZT52C3V9S model card

## Identity

- Manufacturer: hongjiacheng
- Description: -55℃~+150℃ 1 Independent 200mW 3.7V~4.1V 3.9V 3uA 600Ω 90Ω SOD-323 Zener Diodes ROHS
...
- Datasheet: https://jlcpcb.com/api/file/downloadByFileSystemAccessId/8564879703845453824
- Revision: Rev:1.0
- Accessed: 2026-08-09
...
- F2 evidence did not qualify; staged as F1: No usable target-specific DC curve: p. 3 Fig. 1 does not uniquely identify a BZT52C3V9S/3.9 V trace; assigning one of the other labeled family traces would substitute another voltage, so curves are omitted rather than substituted or interpolated.
- No usable target-specific DC curve: p. 3 Fig. 1 does not uniquely identify a BZT52C3V9S/3.9 V trace; assigning one of the other labeled family traces would substitute another voltage, so curves are omitted rather than substituted or interpolated.
