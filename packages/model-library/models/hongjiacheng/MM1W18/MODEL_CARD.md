...
- Datasheet: https://jlcpcb.com/api/file/downloadByFileSystemAccessId/8564879450647904256
- Revision: Rev.1.0
- Accessed: 2026-08-10
...
- F2 evidence did not qualify; staged as F1: No usable component-specific diode curve exists in the supplied datasheet: the only relevant drawing is a generic zener function diagram, and the plotted curves are unrelated thermal characteristics.
- No usable component-specific diode curve exists in the supplied datasheet: the only relevant drawing is a generic zener function diagram, and the plotted curves are unrelated thermal characteristics.
