...
- Datasheet: https://assets.nexperia.com/documents/data-sheet/74HC_HCT86.pdf
- Revision: Rev. 7, 2 April 2024
- Accessed: 2026-08-07
- Referenced pages: p. 3, p. 4, p. 5, p. 7
- SHA-256: `efb3cf17b91fff7687988250bdc2ef53029315237d3960e09bfb3f378bf5298f`
...
| --- | ---: | --- |
| KVTC | 9.49454212e+00 | derived_closed_form |
| RINT | 1.00000000e+03 | held_default |
| CINT | 1.49418827e-11 | fitted |
...
| --- | ---: | ---: | --- | ---: | --- |
| voh_loaded_typ | 4.32000000e+00 | 4.31932293e+00 | V | 0.016% | Nexperia 74HC86 Rev. 7, 2 April 2024, p. 4, Table 6 static characteristics, 25 degC TYP loaded VOH = 4.32 V and VOL = 0.15 V at 4 mA |
| vol_loaded_typ | 1.50000000e-01 | 1.50677436e-01 | V | 0.452% | Nexperia 74HC86 Rev. 7, 2 April 2024, p. 4, Table 6 static characteristics, 25 degC TYP loaded VOH = 4.32 V and VOL = 0.15 V at 4 mA |
| tphl_15p | 1.10000000e-08 | 1.10000000e-08 | s | 0.000% | Nexperia 74HC86 Rev. 7, 2 April 2024, p. 5, Table 7 dynamic characteristics, 25 degC TYP tpd = 11 ns, VCC = 5 V, CL = 15 pF; p. 7 tr = tf = 6 ns |
| tplh_15p | 1.10000000e-08 | 1.09996000e-08 | s | 0.004% | Nexperia 74HC86 Rev. 7, 2 April 2024, p. 5, Table 7 dynamic characteristics, 25 degC TYP tpd = 11 ns, VCC = 5 V, CL = 15 pF; p. 7 tr = tf = 6 ns |
| tphl_50p | 1.40000000e-08 | 1.25621000e-08 | s | 10.271% | Nexperia 74HC86 Rev. 7, 2 April 2024, p. 5, Table 7 dynamic characteristics, 25 degC TYP tpd = 14 ns, VCC = 4.5 V, CL = 50 pF; p. 7 tr = tf = 6 ns |
| tplh_50p | 1.40000000e-08 | 1.25856000e-08 | s | 10.103% | Nexperia 74HC86 Rev. 7, 2 April 2024, p. 5, Table 7 dynamic characteristics, 25 degC TYP tpd = 14 ns, VCC = 4.5 V, CL = 50 pF; p. 7 tr = tf = 6 ns |

Worst fitting error: 10.271% for tphl_50p.

Native and WASM agreement: all 7 benches passed. Worst reported relative delta was 1.197e-09 and worst absolute delta was 4.396e-14.
