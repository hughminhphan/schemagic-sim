# LTST-C170KGKT model card

## Identity

- Manufacturer: Optoelectronics
- Description: 0603 green SMD LED
...
- SHA-256: `64ce7f42b14342958480331fc9dac8d96457b2a87afd415c3ef988d45d34941b`
...
| --- | ---: | --- |
| IS | 6.89672214e-21 | fitted |
| N | 2.00000000e+0 | fitted |
| RS | 1.00000000e-1 | fitted |
| EG | 2.17516128e+0 | derived from datasheet wavelength |
...
| --- | ---: | ---: | --- | ---: | --- |
| forward voltage at 2.000e-2 A | 2.200000e+0 | 2.200000e+0 | V | 0.000% | official Lite-On source unavailable |

Worst fitting error: 0.000% for forward voltage at 0.02 A.

Native and WASM agreement: all 3 benches passed. Worst reported relative delta was 3.429e-15 and worst absolute delta was 7.550e-15.
