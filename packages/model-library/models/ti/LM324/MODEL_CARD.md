...
- Description: Quadruple industry-standard operational amplifier
...
- Revision: SLOS066AE, August 1975, revised September 2025
- Accessed: 2026-08-06
- Referenced pages: p. 6, p. 11, p. 13
- SHA-256: `561b0abc1cdb4e7c716e1511df508f43eaeddb6b030bee6560ca9173a93cc48c`
...
| --- | ---: | --- |
| AOL | 1.00000000e+05 | direct or derived datasheet transcription |
| GBW | 1.32394537e+06 | native calibrated |
| SR | 5.30012421e+05 | native calibrated |
| IBIAS | 2.00000000e-08 | direct or derived datasheet transcription |
| IOS | 2.00000000e-09 | direct or derived datasheet transcription |
| VOS | 3.00000000e-03 | direct or derived datasheet transcription |
| ROUT | 5.00000000e+01 | derived from TYP high-side rail drop divided by TYP short-circuit current |
| ILIM | 4.00000000e-02 | direct or derived datasheet transcription |
| VDRP_H | 1.93497805e+00 | native fitted to the 30 V, 10 kohm TYP high-output row |
| VDRP_L | 1.00000000e-02 | held at archetype 10 mV numerical floor; datasheet TYP is 5 mV |
| FP2 | 3.97183611e+06 | held at default placement of three times calibrated GBW; phase margin not published |
| CMRR | 1.00000000e+04 | direct or derived datasheet transcription |
| PSRR | 1.00000000e+05 | direct or derived datasheet transcription |
| VSUP_NOM | 5.00000000e+00 | direct datasheet default test supply |
| IQ | 1.75000000e-04 | direct or derived datasheet transcription |
| EN | 3.50000000e-08 | direct or derived datasheet transcription |

## Fitted versus datasheet

| Quantity | Datasheet | Fitted | Unit | Relative error | Citation |
| --- | ---: | ---: | --- | ---: | --- |
| open-loop gain | 1.000000e+05 | 9.756582e+04 | V/V | 2.434% | p. 11 electrical characteristics, TYP column |
| unity-gain bandwidth | 1.200000e+06 | 1.200000e+06 | Hz | 0.000% | p. 13 operating conditions, TYP column |
| slew rate | 5.000000e+05 | 5.000000e+05 | V/s | 0.000% | p. 13 operating conditions, TYP column |
| high output voltage | 2.800000e+01 | 2.800000e+01 | V | 0.000% | p. 11 electrical characteristics, TYP column |
| low output voltage | 5.000000e-03 | 1.000000e-02 | V | 100.000% | p. 11 electrical characteristics, TYP column |

Worst fitting error: 100.000% for low output voltage (5 mV absolute error, inside the archetype 0.1 V swing tolerance).

Native and WASM agreement: all 9 benches passed. Worst reported relative delta was 1.676e-11 and worst absolute delta was 1.928e-09.
