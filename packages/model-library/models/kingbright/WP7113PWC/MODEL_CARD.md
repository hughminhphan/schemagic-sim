# WP7113PWC model card

## Identity

- Manufacturer: Kingbrightusa
- Description: 5 mm white clear through-hole LED
...
| --- | ---: | --- |
| IS | 2.74797318e-29 | fitted |
| N | 2.00000000e+0 | fitted |
| RS | 1.00000000e-1 | fitted |
| EG | 2.75520429e+0 | derived from datasheet wavelength |
...
| --- | ---: | ---: | --- | ---: | --- |
| forward voltage at 2.000e-2 A | 3.200000e+0 | 3.200000e+0 | V | 0.000% | official Kingbright source unavailable |

Worst fitting error: 0.000% for forward voltage at 0.02 A.

Native and WASM agreement: all 3 benches passed. Worst reported relative delta was 6.379e-15 and worst absolute delta was 1.998e-14.
