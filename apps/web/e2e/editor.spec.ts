...
const expectSimulatorHeader=async(page:Page)=>{await expect(page.locator(".wordmark")).toHaveText("scheMAGIC");await expect(page.getByRole("navigation",{name:"scheMAGIC products"}).getByText("Simulator",{exact:true})).toHaveAttribute("aria-current","page");};
