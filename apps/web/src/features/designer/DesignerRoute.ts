...
export class DesignerRoute {
  ...
  #render(): void {
    ...
    this.#root.innerHTML = `<main class="designer-shell"><header class="designer-chrome"><a class="designer-wordmark" href="/designer">Robonyx <span>Designer</span></a><nav aria-label="Product"><a aria-current="page" href="/designer">Designer</a><a href="${escapeHtml(simulatorPath)}">Simulator</a></nav><span class="designer-local-state"><i></i>RELEASE CANDIDATE</span></header><div class="designer-frame"><nav class="designer-flow-rail" aria-label="Design progress"><ol>${stepItem(1, "Requirements")}${stepItem(2, "Solutions")}${stepItem(3, "Design")}</ol></nav><div class="designer-route">${content}</div></div></main>`;
    this.#bind();
